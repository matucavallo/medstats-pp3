    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            ...
            <p class="mb-3 text-secondary fw-semibold">
                Desde aquí podés administrar los usuarios del sistema.
            </p>
            {{-- Tabla de usuarios --}}
        <div class="bg-white shadow rounded-lg border border-gray-200 overflow-auto">
            <table id="tablaUsuarios" class="table table-hover table-bordered shadow-sm text-center rounded">
                <thead>
                        <tr>
                            <th>Nombre</th>
                            <th>Email</th>
...
$(document).ready(function () {
    $('#tablaUsuarios').DataTable({
        ...
        columnDefs: [
            { orderable: false, targets: [2] } // Desactiva orden en columna Acciones
        ]
    });
});
</script>
